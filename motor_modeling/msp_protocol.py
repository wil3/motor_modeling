...
API_VERSION_MAJOR=                  1  # increment when major changes are made
API_VERSION_MINOR=                  40 # increment after a release, to set the version for all changes to go into the following release (if no changes to MSP are made between the releases, this can be reverted before the release)
...
FLIGHT_CONTROLLER_VERSION_MASK=     0xFFF
